...
![Fastify](https://img.shields.io/badge/Fastify-5.x-000000?style=for-the-badge&logo=fastify)
...
flowchart TD
    ...
    FE["🌐 Web Frontend<br/>React • TypeScript • Vite"]

    API["⚡ Fastify API<br/>REST • OpenAPI"]
    ...
    SHARED["📚 Shared Domain Packages<br/><br/>Validation • SDK • Types • UI • Utilities"]
...
flowchart TB
    ...
    subgraph Applications["Application Layer"]
        WEB["🖥️ React Frontend<br/>Vercel"]
        API["⚡ Fastify API<br/>Railway / VPS"]
    end
...
Vestara is being developed in carefully planned phases.
